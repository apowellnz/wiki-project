    ...
    public async Task<NotificationDto> SendNotificationAsync(Guid userId, string message)
        {
            ...
            return new NotificationDto(n.Id, n.UserId, n.Message, n.IsRead, n.CreatedAt);
        }
        ...
        public Task<IEnumerable<NotificationDto>> GetNotificationsAsync(Guid userId)
        {
            ...
            var list = _db.Notifications.Where(x => x.UserId == userId)
                ...
                .Select(x => new NotificationDto(x.Id, x.UserId, x.Message, x.IsRead, x.CreatedAt))
                .ToList();
    ...
    public Task<NotificationPageDto> GetNotificationsAsync(Guid userId, int page, int pageSize)
        {
            ...
            var pageDto = new NotificationPageDto(pageItems, total, page, pageSize);
